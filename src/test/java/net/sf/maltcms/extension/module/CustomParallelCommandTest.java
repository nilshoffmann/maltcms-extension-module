 ...
 */
@Slf4j
public class CustomParallelCommandTest extends AFragmentCommandTest {

    @Test
    public void testInvalidParameterValidation() {

        CustomParallelCommand cc = new CustomParallelCommand();
        cc.setMyCustomNumericParameter(50);
        ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
        Validator validator = factory.getValidator();
        Set<ConstraintViolation<CustomParallelCommand>> s = validator.validate(cc);
    ...
    public void testValidParameterValidation() {
        ...
        CustomParallelCommand cc = new CustomParallelCommand();
        cc.setMyCustomParameter("nothing");
    ...
    public void testCustomCommand() throws IOException {
        ...
        w.setExecuteLocal(true);
        w.getConfiguration().setProperty("cross.Factory.maxthreads", 2);
        testWorkflow(w);
    }
}
